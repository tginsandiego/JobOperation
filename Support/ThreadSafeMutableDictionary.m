...
// Part of Uni Call by Guan Gui and licensed under a Creative Commons Attribution-ShareAlike 4.0 International License.
...
- (instancetype)initCommon
{
    self = [super init];
    if (self) {
        isolationQueue_ = dispatch_queue_create([@"ThreadSafeMutableDictionary Isolation Queue" UTF8String], DISPATCH_QUEUE_CONCURRENT);
    }
    return self;
}
